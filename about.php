...
<html lang="ru">
  ...
  <body class="about-page">
    ...
    <header class="header header-single">
      <div class="container">
        <div class="header-content">
          ...
          <h1 class="header-title header-title-light">О компании</h1>
    ...
    <!---
		<header class="header header-single-image">
      <div class="container">
        <div class="header-content">
          <div class="separator"></div>

          <h1 class="header-title header-title-light">Автомобильная химия</h1>
            ...
            <ul class="breadcrumbs-list">
              <li class="breadcrumbs-item">
                <a href="/index.html" class="breadcrumbs-link">Главная</a>
							...
							<li class="breadcrumbs-item">
                <a href="/contract-product.html" class="breadcrumbs-link">Контрактное производство</a>
              </li>

              <li>
                <a href="/product-autohim.html" class="breadcrumbs-link active"
            ...
            <ul class="breadcrumbs-list">
              <li class="breadcrumbs-item">
                <a href="/index.html" class="breadcrumbs-link">Главная</a>
							...
							<li class="breadcrumbs-item">
                <a href="/contract-product.html" class="breadcrumbs-link">Блог</a>
              </li>
